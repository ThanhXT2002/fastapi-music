    ...
    async def _download_song_background(self, song_id: str, url: str, video_info: Dict, quality: str):
        ...
        try:
            ...
            if song:
                ...
                song.is_ready = True
                # Store the actual file path from the download result
                if 'local_audio_path' in download_result:
                    song.audio_file_path = download_result['local_audio_path']
                else:
                    # Fallback: construct path from download result info
                    audio_path = download_result.get('output_path', '')
                    if audio_path and os.path.exists(audio_path):
                        song.audio_file_path = audio_path
